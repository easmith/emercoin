...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    // itecocoin: TODO: sign alerts with itecocoin key
...
//    }
    ...
    // Matches:
    // itecocoin: for some bitcoin test alerts are read with nExpiration == 0, making following tests fail.
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    // itecocoin: following tests requires alertnotify.txt to exist, but for some reason this file is deleted at next instruction...
