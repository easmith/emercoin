...
enum
{
    ...
    // modifiers
    SER_POSMARKER       = (1 << 18),  // itecocoin: for sending block headers with PoS marker, to allow headers-first syncronization
    SER_BTC_TX          = (1 << 19),  // itecocoin: for merged mining, to read tx without nTime.
};
